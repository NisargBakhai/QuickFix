...
public class relectriciansss extends AppCompatActivity {
    private Button next;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_relectriciansss);
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent r=new Intent(relectriciansss.this,relectricianssss.class);
                startActivity(r);
            }});
        ...
        previous.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent r=new Intent(relectriciansss.this,relectricianss.class);
                startActivity(r);
            }});
        FirebaseDatabase database = FirebaseDatabase.getInstance();
        myRef = database.getReference().child("Rajkot").child("Electrician").child("E4");
    ...
    public void showData(){
        ...
        book.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent r=new Intent(relectriciansss.this,bookinge.class);
